...
1.  **Analyze Creative Input & User Specifications:**
    ...
    *   **User Specifications:** The user will provide key directives in their prompt, including **MV Genre**, **Nationality**, **Character Consistency**, and **Number of Characters**. You must adhere to these specifications strictly.
...
1.  **Create a MASTER STYLE:** Based on the mood of the creative input and the specified MV Genre, define a single, consistent cinematic style string. This string will be used in every single prompt. Example: \`'Cinematic, shot on 35mm film with a grainy texture, shallow depth of field, naturalistic and soft lighting, a desaturated color palette of blues and greys, evoking a sense of melancholic nostalgia. The camera movement is slow and observational.'\`
